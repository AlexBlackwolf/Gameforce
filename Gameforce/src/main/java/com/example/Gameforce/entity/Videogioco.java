...
public class Videogioco extends AuditableEntity{
    ...
    public Videogioco(Long id, String createdOn, String createBy, String modifyBy, String modifyOn, Integer codiceVideogioco, String titolo, List<VideogiocoEnum>generi, List<PiattaformaEnum> piattaforma, Double prezzo, Double valutazione, String descrizione, String requisitiDiSistema, Ordine ordine) {
